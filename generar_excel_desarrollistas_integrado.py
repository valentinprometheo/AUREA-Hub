...
empresas = [
    ...
    ("ATV Arquitectos", "Desarrollista Boutique",
     "+54 11 4890-7070 / WA: +54 11 4096-0600", "",
     "atvarquitectos.com", "",
     "", "Palermo",
    ...
    ("Izrastzoff", "Inmobiliaria Premium",
     "+54 11 5279-1001 / WA: +54 9 11 3830-9311", "",
     "izr.com.ar", "",
    ...
    ("Llauro Propiedades", "Inmobiliaria Premium",
     "+54 11 4816-8000 / WA: +54 9 11 4047-1616", "",
     "llauro.com.ar", "",
    ...
    ("LJ Ramos", "Inmobiliaria Premium",
     "+54 11 4114-1000 / WA: +54 9 11 4114-1000", "",
     "ljramos.com", "",
     "", "CABA y GBA",
    ...
    ("Toribio Achával", "Inmobiliaria Premium",
     "+54 11 4819-4000 / WA: +54 9 11 6525-6809", "",
     "toribioachaval.com", "",
     "", "CABA y GBA",
    ...
    ("Miranda Bosch", "Inmobiliaria Premium",
     "+54 11 4815-3515 / WA: +54 9 11 2305-9696", "",
     "mirandabosch.com", "",
     "", "CABA premium",
    ...
    ("Korn Propiedades", "Inmobiliaria Premium",
     "+54 9 11 7856-7071 / 0810-444-5676", "",
